...
public class ShopItemMapper {
    ...
    public ShopItem getItem(int id) {
        ...
        String query = "SELECT itemName, itemPicture, itemPrice FROM shopitems "
                + "WHERE itemid = ? ";
        ...
        try {
            ...
            if (result) {
                ...
                item = new ShopItem(rs.getString("itemName"), rs.getString("itemPicture"), rs.getDouble("itemPrice"));
            }else{
                return null;
            }
    ...
    public List<ShopItem> getAllItems() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ShopItem item = new ShopItem(name, picture, price);
                shopItems.add(item);
            }
