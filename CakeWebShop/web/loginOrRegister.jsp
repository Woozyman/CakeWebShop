...
<c:import url="header.jsp"></c:import>
    ...
    <div class="container">
        ...
        <button type="submit" formaction="${pageContext.servletContext.contextPath}/AccountController?action=register" class="btn btn-default"><span class="glyphicon glyphicon-log-in"></span> Login</button> 
    </form>
</div>
